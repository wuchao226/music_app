...
import com.wuc.voice.model.discory.RecommandFooterValue;
import com.wuc.voice.model.discory.RecommandHeadValue;

public class DiscoveryNewView extends RelativeLayout {
  ...
  public DiscoveryNewView(Context context, RecommandHeadValue recommandHeadValue) {
    this(context, null, recommandHeadValue);
  }

  public DiscoveryNewView(Context context, AttributeSet attrs,
