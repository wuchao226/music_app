...
package com.wuc.lib_qrcode.zxing.camera;
...
import com.wuc.lib_qrcode.zxing.camera.open.OpenCamera;
import com.wuc.lib_qrcode.zxing.camera.open.OpenCameraInterface;
...
public final class CameraManager {
    ...
    public void turnLightOn() {
        ...
        Parameters parameters = camera.getCamera().getParameters();
        if (parameters == null) {
            return;
        }
